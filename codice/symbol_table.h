...
#include <string.h> /** Serve per la gestione delle stringhe nella tabella dei simboli. */
#include "utility.h" /** Il file utility.h contiene delle funzioni e dei tipi di variabile di supporto al processo di compilazione e traduzione. */
#include "gen_code.h" /** Il file gen_code.h contiene delle funzioni utili al processo di traduzione. */
#include "uthash.h" /** Il file uthash.h è una libreria di gestione degli indici HASH, utili per la gestione dei record della symbol table. */
